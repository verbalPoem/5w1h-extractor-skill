...
1. 找到当前仓库中的 `5w1h-extractor/` 和 `ceh-5w1h/` 文件夹。
2. 确认这些文件夹中存在 `SKILL.md`。
3. 将整个 `5w1h-extractor/` 和 `ceh-5w1h/` 文件夹复制到当前用户的 Codex skills 目录：
...
5. 不要删除或覆盖其他 skill。
6. 如果目标目录中已经存在同名 skill 文件夹，请先告诉我，再覆盖安装。
